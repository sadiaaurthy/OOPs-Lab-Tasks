...
public:
    ...
    // Make displayDetails a pure virtual function
    virtual void displayDetails() const = 0; // Pure virtual function making Person an abstract class
};

class Student : protected Person { //protected -> Don't want to access outside classes just want it to be inherited in other classes
private:
    string studentID;
    float currentCGPA;
public: 
